        ...
        <div class="card mb-5">
          ...
          <div class="col-md-12">
            <div class="text-left ml-3">
              <a href="{{ url('data-balita/pengukuran') }}/{{ $data->nik }}"
            ...
            <div class="card" style="border: none">
              ...
              <form action="{{ url('/data-balita/pengukuran/edit-process') }}" method="post"
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-md-6 mb-3">
                      ...
                      <input type="text" class="form-control" name="nik_balita" value="{{ $data->nik }}" required
                        readonly>
                    </div>
                    <div class="col-md-6 mb-3">
