        ...
        <div class="card mb-5">
          ...
          <div class="col-md-12">
            <div class="text-left ml-3">
              <a href="{{ url('data-balita/pengukuran') }}/{{ $id }}"
            ...
            <div class="card" style="border: none">
              ...
              <form action="{{ url('/data-balita/pengukuran/add-process') }}" method="post" enctype="multipart/form-data"
                autocomplete="off">
                <div class="card-body">
                  {{ csrf_field() }}
                  <div class="row">
                    <input type="hidden" name="balita_id" value="{{ $id }}">
