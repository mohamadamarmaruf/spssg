        ...
        <div class="card mb-5">
          <div class="page-header-content header-elements-md-inline" style="background-color:	#354c7c;color:white">
            <div class="page-title d-flex" style="padding-top:1% !important;padding-bottom:1% !important;">
              <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Home</span> - Detail Data
                Pengukuran {{ ucwords($data->nama_balita) }}
              </h4>
          ...
          <div class="col-md-12">
            <div class="text-left ml-3">
              <a href="{{ url('data-balita/pengukuran') }}/{{ $data->balita_id }}"
              ...
              <form>
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                      <label>Nama </label>
                      <input class="form-control" name="tgl_ukur" value="{{ ucwords($data->nama_balita) }}" readonly>
                    </div>
                    <div class="col-md-3 mb-3">
                      <label>Umur (Bulan) </label>
                      <input class="form-control" name="tgl_ukur" value="{{ ucwords($data->age) }}" readonly>
                    </div>
                    <div class="col-md-3 mb-3">
                      <label>Tanggal Pengukuran </label>
                      <input class="form-control" name="tgl_ukur"
                        value="{{ \Carbon\Carbon::parse($data->tgl_ukur)->locale('id_ID')->translatedFormat('d F Y') }} "
                        readonly>
                    </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                      ...
                      <input class="form-control" value="{{ $data->stunting }} " readonly>
                    </div>
                  </div>
                </div>
              </form>
