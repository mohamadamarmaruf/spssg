              ...
              <div class="card-body">
                <div class="divider divider-dashed">
                  <div class="divider-text">
                    <strong> Data {{ $data->nama_balita }}</strong>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-6 mb-3">
                    <label>Nama </label>
                    <input type="text" class="form-control" value="{{ $data->nama_balita }}" readonly>
                  </div>
                  <div class="col-md-6 mb-3">
                ...
                <div class="row">
                  ...
                  <div class="col-md-3 mb-3">
                    ...
                    <input type="text" class="form-control" value="{{ $data->no_kk_user }}" readonly>
                  </div>
                ...
                <div class="row">
                  <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" value="{{ $data->nama_ortu }}" readonly>
                  </div>
                  <div class="col-md-6 mb-3">
