            ...
            <div class=" card" style="border: none">
              @if ($role == 'super admin' | $role=='admin')
                <div class="text-right">
                  <a href="{{ url('data-edukasi/add') }}" class=" mt-3 mb-1 p-0 pl-1 pr-1 btn-sm btn btn-outline-info">
                    ...
                    <tbody>
                      @foreach ($rs_edu as $data)
                        <tr>
                          ...
                          <td>{{ $data->pesan }} </td>
                          <td>
                            <a href="{{ url('data-edukasi/edit') }}/{{ $data->id }}"
                              class="btn btn-outline-warning btn-sm p-0 pl-1 pr-1">Edit</a>
                            <a href="{{ url('data-edukasi/delete') }}/{{ $data->id }}"
