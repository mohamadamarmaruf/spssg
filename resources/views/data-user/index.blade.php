            ...
            <div class=" card" style="border: none">
              @if ($role == 'super admin')
                <div class="text-right">
                  <a href="{{ url('data-user/add') }}" class="  mt-3 mb-1 p-0 pl-1 pr-1  btn-sm btn btn-outline-info">
              ...
              @elseif($role == 'admin')
                <div class="divider divider-dashed mt-4">
                  <div class="divider-text">
                    <strong> Detail Data {{ $rs_user->nama_posyandu }}</strong>
                  </div>
                </div>
                <div class="row m-2">
                  <div class="col-md-4 mb-3">
                    <label>Nama</label>
                    <input class="form-control" value="{{ $rs_user->name }}" readonly>
                  </div>
                  <div class="col-md-4 mb-3">
                    <label>Nama Posyandu</label>
                    <input class="form-control" value="{{ $rs_user->nama_posyandu }}" readonly>
                  </div>
                  <div class="col-md-4 mb-3">
                    <label>Kode Pos</label>
                    <input class="form-control" value="{{ $rs_user->kode_pos }}" readonly>
                  </div>
                </div>
                <div class="row m-2">
                  <div class="col-md-4 mb-3">
                    <label>Username </label>
                    <input class="form-control" value="{{ $rs_user->username }}" readonly>
                  </div>
                  <div class="col-md-4 mb-3">
                    <label>Role </label>
                    <input class="form-control" value="{{ $rs_user->role }}" readonly>
                  </div>
                </div>
              @elseif($role == 'user')
                <div class="divider divider-dashed mt-4">
                  <div class="divider-text">
                    <strong> Detail Data {{ $rs_user->name }}</strong>
                  </div>
                </div>
                <div class="row m-2">
                  ...
                  <div class="col-md-3 mb-3">
                    ...
                    <input class="form-control" value="{{ $rs_user->no_kk }}" readonly>
                  </div>
                  <div class="col-md-3 mb-3">
                    <label>Role </label>
                    <input class="form-control" value="{{ $rs_user->role }}" readonly>
